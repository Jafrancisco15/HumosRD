...
test('analysis span supports 10-minute steps and fractional hours',()=>{const p=trajectory([18.5,-69.9],start,1.5,hourly);assert.equal(p.points.length,10);assert.equal(p.times.at(-1),start+90*60000);});
