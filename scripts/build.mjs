...
for (const f of ['dist/index.html','dist/app.js','dist/automatic.js','dist/smoke-core.js','dist/style.css','dist/enhancements.css','dist/core.js','dist/provinces.geojson']) await access(f);
